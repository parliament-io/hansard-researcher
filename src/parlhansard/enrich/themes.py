...
Labels come from the open seed taxonomy (:mod:`parlhansard.reference.themes`)
...
from parlhansard.enrich.embed import Embedder, HouseDay, iter_house_days, model_slug
from parlhansard.reference.themes import Theme, load_themes, locale_for
